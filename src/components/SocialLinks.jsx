...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/hamza-zily-5a9270302/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mizzy.in4k",
    icon: Instagram,
    url: "https://www.instagram.com/mizzy.in4k/",
    color: "#E4405F",
    ...
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        {[instagram].map((link) => (
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-0 opacity-20 rounded-md transition-all duration-500
                             group-hover:scale-110 group-hover:opacity-30"
        ...
        {[github].map((link) => (
          <a
            ...
            className="group relative flex items-center justify-between p-4 rounded-lg 
                     ...
                     hover:border-white/20 transition-all duration-500"
          >
            {/* Copy the same structure as LinkedIn and Instagram above */}
            <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
                           bg-gradient-to-r ${link.gradient}`} />
